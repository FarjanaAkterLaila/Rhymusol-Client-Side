  ...
  return (
    <footer>
      <div className="footer p-10 bg-base-200 text-base-content">
        ...
        <div >
          <span className=" footer-title font-bold text-orange-700 text-xl">Services</span>
          <a className="link link-hover text-black text-sm">Design</a>
          <a className="link link-hover text-black text-sm">Marketing</a>
          <a className="link link-hover text-black text-sm">Advertisement</a>
        </div>
        <div>
          <span className="footer-title font-bold text-orange-700 text-xl">Explore</span>
          <a className="link link-hover text-black text-sm">About us</a>
          <a className="link link-hover text-black text-sm">Contact</a>
          <a className="link link-hover text-black text-sm">Login</a>

        </div>
        <div>
          <span className="footer-title font-bold text-orange-700 text-xl">Legal</span>
